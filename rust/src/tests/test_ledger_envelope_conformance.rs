...
/// reviewed.
pub const APP_SOLANA_PIN: &str = "c855c1a0ea12e76406efbfd17203ecf419952e27";

/// Size of an ed25519 public key, as `app-solana` counts it in the header.
...
mod tests {
    ...
    fn our_header_length_matches_the_app_solana_definition() {
        ...
        let ours = crate::ledger::ledger_offchain_envelope(
            &crate::sdk_adapter::Pubkey::from([0u8; 32]),
            b"x",
        )
