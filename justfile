...
ts-test-integration:
    ...
    pnpm -F @solana/keychain-fireblocks -F @solana/keychain-fordefi -F @solana/keychain-privy -F @solana/keychain-turnkey -F @solana/keychain-utila -F @solana/keychain-vault test:integration
...
release-ts: _check-ts-release
    ...
    PACKAGES="core aws-kms cdp dfns fireblocks fordefi gcp-kms memory openfort para privy turnkey utila vault keychain kit-plugin test-utils crossmint"
...
publish-ts package="all" branch="":
    ...
    valid="all core aws-kms cdp crossmint dfns fireblocks fordefi gcp-kms memory openfort para privy turnkey utila vault keychain"
